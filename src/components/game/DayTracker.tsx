...
export const DayTracker = ({ day, phase }: DayTrackerProps) => {
  ...
  return (
    <div className="day-tracker rounded-lg border border-primary/20 bg-gradient-to-b from-slate-900/80 to-slate-950/90 p-2 shadow-lg">
      {/* Compact Day Boxes */}
      <div className="flex items-center gap-1 mb-2">
        {DAYS.map((dayName, index) => {
          ...
          return (
            <div
              key={dayName}
              className={`flex-1 flex flex-col items-center justify-center rounded border p-1 transition-all ${
                isCurrentDay
      ...
      <div className={`flex items-center justify-center gap-2 rounded ${phaseInfo.bg} p-1.5`}>
