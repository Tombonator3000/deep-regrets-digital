...
const no: Translations = {
  ...
  startScreen: {
    ...
    aiSpeed: 'AI-hastighet',
    slow: 'Langsom',
    normal: 'Normal',
    fast: 'Rask',
    aiSpeedSlow: 'AI-en tar seg bedre tid før og etter handlingene.',
    aiSpeedNormal: 'Balansert tempo for tenke- og visningsfaser.',
    aiSpeedFast: 'AI-en hopper raskt gjennom tenking og handlinger.',
    easy: 'Lett',
    medium: 'Medium',
    hard: 'Vanskelig',
...
const en: Translations = {
  ...
  startScreen: {
    ...
    normal: 'Normal',
    fast: 'Fast',
    aiSpeedSlow: 'AI takes more time before and after moves.',
    aiSpeedNormal: 'Balanced pacing for thinking and display phases.',
    aiSpeedFast: 'AI zips through thinking and action displays.',
    easy: 'Easy',
    medium: 'Medium',
    hard: 'Hard',
